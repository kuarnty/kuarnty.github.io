...
title: Vector
description:
category: Computer Sciences - Data Structures - Vector
---
...
먼저 [배열(array)](/pages/computer-sciences/data-structures/array.html)에 대한 이해가 필요합니다.
...
근본적으로, 새 요소를 하나 추가할 때 그만큼 공간을 할당받아 기존 배열에 더해 줄 필요가 있는데, 배열은 크기 변경이 불가능하므로 할당받은 공간을 기존 배열에 붙이거나 할 수 없습니다. (이런 작업은 [Linked List](/pages/computer-sciences/data-structures/linked-list.html)에서 가능합니다.)
...
[GitHub - 벡터 구현 예시(cpp) - cpp의 std::vector를 사용하지 않고 벡터 자료구조를 직접 구현한 예시](https://github.com/kuarnty/implement-CS/blob/main/data-structures/Vector.cpp) 
